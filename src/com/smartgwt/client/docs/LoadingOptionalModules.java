 ...
 * Required for all {@link com.smartgwt.client.widgets.plugins.BrowserPlugin} derivatives (such as {@link
 * com.smartgwt.client.widgets.plugins.Applet} and {@link com.smartgwt.client.widgets.plugins.Flashlet}) and
 ...
 *  See {@link com.smartgwt.client.widgets.chart.FacetChart} and FusionChart.
 * Note that {@link com.smartgwt.client.widgets.chart.FacetChart} also requires the <code>Drawing</code> module to be
 * loaded
 *  before this module.
 *  Note that FusionChart also requires the <code>PluginBridges</code> module be loaded before this 
 *  module.
 *  </td>
 ...
 *  See {@link com.smartgwt.client.widgets.cube.CubeGrid}. Note that if charting is also required, the <code>Charts</code>
