 ...
 * All of the libraries that Smart GWT depends upon have either an Apache 1.0 or Apache 2.0 license, with the following
 * exceptions:<br> 1. Optional Hibernate support requires LGPL-licensed .jars from Hibernate<br> 2. Optional support for
 * PDF Export requires Flying Saucer, iText and jTidy, introducing:<br> &nbsp;&nbsp;- Flying Saucer: core-render.jar: <a
 * href='http://www.gnu.org/licenses/lgpl-2.1.html'
 * onclick="window.open('http://www.gnu.org/licenses/lgpl-2.1.html');return false;">LGPL license</a><br> &nbsp;&nbsp;-
 * iText: iText-2.0.8.jar: <a href='http://www.mozilla.org/MPL/1.1/'
 * onclick="window.open('http://www.mozilla.org/MPL/1.1/');return false;">Mozilla Public License Version 1.1</a><br>
 * &nbsp;&nbsp;- jTidy: jtidy-r938.jar: <a href='http://jtidy.sourceforge.net/license.html'
 * onclick="window.open('http://jtidy.sourceforge.net/license.html');return false;">MIT license</a> <P> If you are using
 * GWT, GWT itself also has an Apache 2.0 license, however tools and test environments that you may use during development
 * have different license (such as Eclipse - Eclipse Public License).  Also, specific GWT widgets, not required by Smart
 * GWT,  have licenses different from core GWT (such as JFreeChart's LGPL license).  See  <a
 ...
 * libraries:<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;poi-ooxml, poi-ooxml-schemas, xbean, jsr173_1.0_api<br><br>
